  ...
  return (
    <>
      <header className='flex justify-between sticky top-0 p-4 items-center'>
        <h2 className='cursor-pointer font-bold text-2xl text-orange-500 hover:text-orange-600'>
        ...
        <ul className='hidden md:flex gap-4 uppercase font-medium'>
          {authState.isLoggedIn ? (
            ...
            <div className='flex'>
              <li className='py-2 px-3 cursor-pointer text-orange-500 hover:text-orange-600 transition rounded-sm font-bold'><Link to="/login">Login</Link></li>
              <li className='py-2 px-3 cursor-pointer text-orange-500 hover:text-orange-600 transition rounded-sm font-bold'><Link to="/signup">SignUp</Link></li>
            </div>
          )}
        </ul>
