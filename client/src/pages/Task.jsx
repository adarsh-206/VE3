        ...
        <form className='m-auto my-16 max-w-[1000px] bg-white p-8 border-2 shadow-md rounded-md'>
          {loading ? (
            ...
            <>
              ...
              <button className='bg-orange-500 text-white px-4 py-2 font-medium hover:bg-orange-600 rounded-lg' onClick={handleSubmit}>{mode === "add" ? "Add task" : "Update Task"}</button>
              <button className='ml-4 bg-orange-500 hover:bg-orange-600 text-white px-4 py-2 font-medium rounded-lg' onClick={() => navigate("/")}>Cancel</button>
              {mode === "update" && <button className='ml-4 bg-orange-500 hover:bg-orange-600 rounded-lg text-white px-4 py-2 font-medium' onClick={handleReset}>Reset</button>}
            </>
          )}
        </form>
      </MainLayout>
