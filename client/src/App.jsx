    ...
    <>
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/tasks" element={authState.isLoggedIn ? <Tasks /> : <Navigate to="/login" state={{ redirectUrl: window.location.pathname }} />} />
          <Route path="/tasks/:taskId" element={authState.isLoggedIn ? <Task /> : <Navigate to="/login" state={{ redirectUrl: window.location.pathname }} />} />
          <Route path="/tasks/edit/:taskId" element={authState.isLoggedIn ? <Task /> : <Navigate to="/login" state={{ redirectUrl: window.location.pathname }} />} />
          <Route path="/tasks/view/:taskId" element={authState.isLoggedIn ? <EachTask /> : <Navigate to="/login" state={{ redirectUrl: window.location.pathname }} />} />
